...
struct Localization {
    ...
    // MARK: B
    static let buyMeACoffee = NSLocalizedString("Buy me a coffee", comment: "")
    ...
    static let debugCopyInstallationID = NSLocalizedString("Copy Installation ID", comment: "")
    static let debugInstallationIDCopied = NSLocalizedString("Installation ID copied", comment: "")
    ...
    static let debugAPIBaseURLRestored = NSLocalizedString("API URL restored to default", comment: "")
    ...
    static let contactEmailSubject = NSLocalizedString("SAES App - Contact", comment: "")
    static let contactEmailBody = NSLocalizedString("Hi, I'm writing about the SAES app.\n\nApp version: %@\niOS version: %@\nDevice: %@\n\n", comment: "")
    ...
    static let schoolMismatchSwitchMessage = NSLocalizedString(
        "This credential is from %@. Do you want to switch to %@?", comment: "")
